...
const CrearRecursoPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/admin/recursos`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        toast.error(error.detail || 'Error al crear recurso');
      }
    } catch (error) {
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-600">Completa la información del recurso educativo</p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Guía de Diagnóstico NIIF S1/S2"
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="1">Fase 1 - Diagnóstico</option>
                    <option value="2">Fase 2 - Materialidad</option>
                    <option value="3">Fase 3 - Riesgos</option>
                    <option value="4">Fase 4 - Medición</option>
                    <option value="5">Fase 5 - Reporte</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#4CAF50]"
                  placeholder="Ej: niif, s1, s2, diagnostico"
                />
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Contenido detallado del recurso (Markdown compatible)..."
                />
                <p className="mt-1 text-xs text-gray-500">
                  Puedes usar formato Markdown para dar estilo al contenido
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  Para videos de YouTube, enlaces externos, etc.
                </p>
              </div>
            </div>
          </div>
...
export default CrearRecursoPage;
